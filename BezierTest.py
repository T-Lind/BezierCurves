...
axis[0][0].scatter(b.get_x(b.point_storage), b.get_y(b.point_storage), alpha=0.1)

# axis[0][0].scatter(b.get_x(b.left_offset_storage), b.get_y(b.left_offset_storage), alpha=0.01, color="RED")
# axis[0][0].scatter(b.get_x(b.right_offset_storage), b.get_y(b.right_offset_storage), alpha=0.01, color="GREEN")
...
# axis[1][0].scatter(b.time_list, b.angles, alpha=0.01)
...
# axis[1][1].plot(b.time_list, b.velocity)
#
